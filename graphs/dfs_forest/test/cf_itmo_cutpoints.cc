// Problem: https://codeforces.com/group/dAhOSPf3oD/contest/404821/problem/C
// Submission:
// https://codeforces.com/group/dAhOSPf3oD/contest/404821/submission/240489213
...
void RunCase([[maybe_unused]] int testcase) {
  ...
  cut_points.reserve(n);
  for (int i = 0; i < n; ++i) {
    if (dfs_forest.IsArticulationPoint(i)) {
      cut_points.push_back(i + 1);
    }
  }

  std::cout << cut_points.size() << "\n";
  for (int id : cut_points) {
    std::cout << id << " ";
  }
}
