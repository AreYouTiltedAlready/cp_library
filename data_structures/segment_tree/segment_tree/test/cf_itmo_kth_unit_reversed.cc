// Problem: https://codeforces.com/group/dAhOSPf3oD/contest/370734/problem/D
// Submission:
// https://codeforces.com/group/dAhOSPf3oD/contest/370734/submission/240223325
...
void RunCase([[maybe_unused]] int testcase) {
  ...
  ds::segment_tree::SegmentTree<int> segment_tree(v);
  while (q--) {
    int t;
    std::cin >> t;
    if (t == 1) {
      ...
      std::cin >> pos;
      pos = n - 1 - pos;
      segment_tree.Set(pos, v[pos] ^= 1);
    } else {
      int k;
      std::cin >> k;
      std::cout << n - 1 - segment_tree.FindLast(0, n, Searcher(k)) << "\n";
    }
  }
}
